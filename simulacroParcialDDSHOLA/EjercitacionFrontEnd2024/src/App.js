...
<Routes>
  ...
  <Route path="/empleadoslistado" element={<EmpleadoListado />} />
  <Route path="/empleados/:id" element={<EmpleadoRegistro />} /> {/* empleados/:id para editar y crear la concha de tu madre */}
